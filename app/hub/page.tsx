...
{/* Stationery Illustration Overlay */}
...
<span className="material-symbols-outlined text-4xl mb-4" data-icon="style">style</span>
<h4 className="font-headline text-2xl font-black mb-2">Flashcards</h4>
<p className="text-sm text-primary-fixed leading-tight">Master concepts through tactile repetition.</p>
...
<h4 className="font-headline text-2xl font-black mb-2">Chatbot</h4>
<p className="text-sm text-secondary-fixed-variant leading-tight">AI Drafting Assistant at your service.</p>
